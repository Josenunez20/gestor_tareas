...
TEMPLATES = [
    {
        ...
        'DIRS': [],  # no es necesario porque usamos la carpeta templates de la app
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_URL = 'login'                # nombre de la URL de login (ahora en raíz)
LOGIN_REDIRECT_URL = 'tareas:tarea_list'   # después de login va a la lista de tareas
